            ...
            <div class="shop-menu">
                <ul>
                    ...
                    <li class="topauth">
                        ...
                        <a href="http://http://127.0.0.1:8000/.com/admin/login">
                    ...
                    <li>
                        <div class="h-cart">
                            <a href="http://http://127.0.0.1:8000/.com/gio-hang">
        ...
        <div class="container">
            <nav class="topmenu">
                ...
                <ul class="mainmenu">
                    ...
                    <li><a href="http://http://127.0.0.1:8000/.com/tin-tuc" class="">Tin Tức</a></li>
                    <li><a href="./" class="">Hỏi Đáp</a></li>
                    <li><a href="./" class="">Giới Thiệu</a></li>
                    <li><a href="http://http://127.0.0.1:8000/.com/lien-he" class="">Liên Hệ</a></li>
{{--                    @if(!empty($categories))--}}
{{--                        @foreach($categories as $category)--}}
{{--                            @if($category->parent_id == 0)--}}
